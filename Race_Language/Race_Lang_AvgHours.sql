--What is the average participation for class enrollees by race / native language? 

SELECT race_ethnicity, native_language, 
COUNT (studid)Total_Students, 
ROUND (AVG (class_hours),2)as Class_Hours, 
ROUND (AVG (wkshp_hours),2) as Worhshop_Hours,
